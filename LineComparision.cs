...
namespace LineComparision
{
    internal class LineComparision
    {
        public static double CompLine()
        {
            ...
            Console.WriteLine("Enter x1 of line1");             /*Converting string to double*/
            x1 = Convert.ToDouble(Console.ReadLine());          /*x1,y1,z1 convertion string to double*/
            ...
            if (length == length1)                    /*if-->Comparision*/
            {
